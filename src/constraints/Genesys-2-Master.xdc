...
## LEDs
#set_property -dict { PACKAGE_PIN T28   IOSTANDARD LVCMOS33 } [get_ports { cam_pwup_tri_o }]; #IO_L11N_T1_SRCC_14 Sch=led[0]
...
## PMOD Header JA
#set_property -dict { PACKAGE_PIN U28   IOSTANDARD LVCMOS33 } [get_ports { cam_iic_scl_io }]; #IO_L13N_T2_MRCC_14 Sch=ja_n[1]
#set_property -dict { PACKAGE_PIN U27   IOSTANDARD LVCMOS33 } [get_ports { cam_iic_sda_io }]; #IO_L13P_T2_MRCC_14 Sch=ja_p[1]
...
## PMOD Header JC
#set_property -dict { PACKAGE_PIN AC26  IOSTANDARD LVCMOS33 } [get_ports { cam_iic_scl_io }]; #IO_L19P_T3_13 Sch=jc[1]
#set_property -dict { PACKAGE_PIN AJ27  IOSTANDARD LVCMOS33 } [get_ports { cam_iic_sda_io }]; #IO_L20P_T3_13 Sch=jc[2]
...
#set_property -dict { PACKAGE_PIN AG30  IOSTANDARD LVCMOS33 } [get_ports { stream_out_TUSER_0[0] }]; #IO_L18P_T2_13 Sch=jc[8]
...
set_property -dict { PACKAGE_PIN C27   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_b_hs_clock_clk_n }]; #IO_L13N_T2_MRCC_16 Sch=fmc_la_n[00]
set_property -dict { PACKAGE_PIN D27   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_b_hs_clock_clk_p }]; #IO_L13P_T2_MRCC_16 Sch=fmc_la_p[00]
set_property -dict { PACKAGE_PIN C26   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_a_hs_clock_clk_n }]; #IO_L11N_T1_SRCC_16 Sch=fmc_la_n[01]
set_property -dict { PACKAGE_PIN D26   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_a_hs_clock_clk_p }]; #IO_L11P_T1_SRCC_16 Sch=fmc_la_p[01]
set_property -dict { PACKAGE_PIN G30   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_b_data_hs_n[0] }]; #IO_L24N_T3_16 Sch=fmc_la_n[02]
set_property -dict { PACKAGE_PIN H30   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_b_data_hs_p[0] }]; #IO_L24P_T3_16 Sch=fmc_la_p[02]
set_property -dict { PACKAGE_PIN E30   IOSTANDARD LVCMOS25 } [get_ports { dphy_a_data_lp_n[0] }]; #IO_L18N_T2_16 Sch=fmc_la_n[03]
set_property -dict { PACKAGE_PIN E29   IOSTANDARD LVCMOS25 } [get_ports { dphy_a_data_lp_p[0] }]; #IO_L18P_T2_16 Sch=fmc_la_p[03]
set_property -dict { PACKAGE_PIN H27   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_b_data_hs_n[1] }]; #IO_L23N_T3_16 Sch=fmc_la_n[04]
set_property -dict { PACKAGE_PIN H26   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_b_data_hs_p[1] }]; #IO_L23P_T3_16 Sch=fmc_la_p[04]
set_property -dict { PACKAGE_PIN A30   IOSTANDARD LVCMOS25 } [get_ports { dphy_b_data_lp_n[1] }]; #IO_L17N_T2_16 Sch=fmc_la_n[05]
set_property -dict { PACKAGE_PIN B30   IOSTANDARD LVCMOS25 } [get_ports { dphy_b_data_lp_p[1] }]; #IO_L17P_T2_16 Sch=fmc_la_p[05]
set_property -dict { PACKAGE_PIN C30   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_a_data_hs_n[1] }]; #IO_L16N_T2_16 Sch=fmc_la_n[06]
set_property -dict { PACKAGE_PIN D29   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_a_data_hs_p[1] }]; #IO_L16P_T2_16 Sch=fmc_la_p[06]
set_property -dict { PACKAGE_PIN E25   IOSTANDARD LVCMOS25 PULLUP true} [get_ports { cama_gpio_tri_io[0] }]; #IO_L3N_T0_DQS_16 Sch=fmc_la_n[07]
set_property -dict { PACKAGE_PIN F25   IOSTANDARD LVCMOS25 DRIVE 4} [get_ports { cam_pwup_tri_o }]; #IO_L3P_T0_DQS_16 Sch=fmc_la_p[07]
set_property -dict { PACKAGE_PIN B29   IOSTANDARD LVCMOS25 } [get_ports { dphy_a_clk_lp_n }]; #IO_L15N_T2_DQS_16 Sch=fmc_la_n[08]
set_property -dict { PACKAGE_PIN C29   IOSTANDARD LVCMOS25 } [get_ports { dphy_a_clk_lp_p }]; #IO_L15P_T2_DQS_16 Sch=fmc_la_p[08]
set_property -dict { PACKAGE_PIN A28   IOSTANDARD LVCMOS25 } [get_ports { dphy_b_clk_lp_n }]; #IO_L9N_T1_DQS_16 Sch=fmc_la_n[09]
set_property -dict { PACKAGE_PIN B28   IOSTANDARD LVCMOS25 } [get_ports { dphy_b_clk_lp_p }]; #IO_L9P_T1_DQS_16 Sch=fmc_la_p[09]
set_property -dict { PACKAGE_PIN A27   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_a_data_hs_n[0] }]; #IO_L7N_T1_16 Sch=fmc_la_n[10]
set_property -dict { PACKAGE_PIN B27   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_a_data_hs_p[0] }]; #IO_L7P_T1_16 Sch=fmc_la_p[10]
set_property -dict { PACKAGE_PIN A26   IOSTANDARD LVCMOS25 PULLUP true} [get_ports { cama_gpio_tri_io[2] }]; #IO_L10N_T1_16 Sch=fmc_la_n[11]
set_property -dict { PACKAGE_PIN A25   IOSTANDARD LVCMOS25 PULLUP true} [get_ports { cama_gpio_tri_io[1] }]; #IO_L10P_T1_16 Sch=fmc_la_p[11]
set_property -dict { PACKAGE_PIN E26   IOSTANDARD LVCMOS25 } [get_ports { dphy_a_data_lp_n[1] }]; #IO_L5N_T0_16 Sch=fmc_la_n[12]
set_property -dict { PACKAGE_PIN F26   IOSTANDARD LVCMOS25 } [get_ports { dphy_a_data_lp_p[1] }]; #IO_L5P_T0_16 Sch=fmc_la_p[12]
set_property -dict { PACKAGE_PIN D24   IOSTANDARD LVCMOS25 } [get_ports { dphy_b_data_lp_n[0] }]; #IO_L4N_T0_16 Sch=fmc_la_n[13]
set_property -dict { PACKAGE_PIN E24   IOSTANDARD LVCMOS25 } [get_ports { dphy_b_data_lp_p[0] }]; #IO_L4P_T0_16 Sch=fmc_la_p[13]
#set_property -dict { PACKAGE_PIN B24   IOSTANDARD LVCMOS12 } [get_ports { fmc_la_n[14] }]; #IO_L8N_T1_16 Sch=fmc_la_n[14]
set_property -dict { PACKAGE_PIN C24   IOSTANDARD LVCMOS25 } [get_ports { cam_gpio_oen[0] }]; #IO_L8P_T1_16 Sch=fmc_la_p[14]
set_property -dict { PACKAGE_PIN A23   IOSTANDARD LVCMOS25 } [get_ports { cam_gpio_dir[0] }]; #IO_L1N_T0_16 Sch=fmc_la_n[15]
set_property -dict { PACKAGE_PIN B23   IOSTANDARD LVCMOS25 PULLUP true} [get_ports { cama_gpio_tri_io[3] }]; #IO_L1P_T0_16 Sch=fmc_la_p[15]
set_property -dict { PACKAGE_PIN D23   IOSTANDARD LVCMOS25 } [get_ports { cama_bta_tri_io[1] }]; #IO_L2N_T0_16 Sch=fmc_la_n[16]
set_property -dict { PACKAGE_PIN E23   IOSTANDARD LVCMOS25 } [get_ports { cama_bta_tri_io[0] }]; #IO_L2P_T0_16 Sch=fmc_la_p[16]
set_property -dict { PACKAGE_PIN E21   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_c_hs_clock_clk_n }]; #IO_L11N_T1_SRCC_17 Sch=fmc_la_n[17]
set_property -dict { PACKAGE_PIN F21   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_c_hs_clock_clk_p }]; #IO_L11P_T1_SRCC_17 Sch=fmc_la_p[17]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_d_hs_clock_clk_n }]; #IO_L13N_T2_MRCC_17 Sch=fmc_la_n[18]
set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_d_hs_clock_clk_p }]; #IO_L13P_T2_MRCC_17 Sch=fmc_la_p[18]
set_property -dict { PACKAGE_PIN H22   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_c_data_hs_n[1] }]; #IO_L7N_T1_17 Sch=fmc_la_n[19]
set_property -dict { PACKAGE_PIN H21   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_c_data_hs_p[1] }]; #IO_L7P_T1_17 Sch=fmc_la_p[19]
set_property -dict { PACKAGE_PIN F22   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_c_data_hs_n[0] }]; #IO_L9N_T1_DQS_17 Sch=fmc_la_n[20]
set_property -dict { PACKAGE_PIN G22   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_c_data_hs_p[0] }]; #IO_L9P_T1_DQS_17 Sch=fmc_la_p[20]
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS25 } [get_ports { dphy_d_clk_lp_n }]; #IO_L5N_T0_17 Sch=fmc_la_n[21]
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS25 } [get_ports { dphy_d_clk_lp_p }]; #IO_L5P_T0_17 Sch=fmc_la_p[21]
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS25 } [get_ports { dphy_c_clk_lp_n }]; #IO_L3N_T0_DQS_17 Sch=fmc_la_n[22]
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS25 } [get_ports { dphy_c_clk_lp_p }]; #IO_L3P_T0_DQS_17 Sch=fmc_la_p[22]
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_d_data_hs_n[0] }]; #IO_L18N_T2_17 Sch=fmc_la_n[23]
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_d_data_hs_p[0] }]; #IO_L18P_T2_17 Sch=fmc_la_p[23]
set_property -dict { PACKAGE_PIN G20   IOSTANDARD LVCMOS25 } [get_ports { dphy_c_data_lp_n[1] }]; #IO_L2N_T0_17 Sch=fmc_la_n[24]
set_property -dict { PACKAGE_PIN H20   IOSTANDARD LVCMOS25 } [get_ports { dphy_c_data_lp_p[1] }]; #IO_L2P_T0_17 Sch=fmc_la_p[24]
set_property -dict { PACKAGE_PIN C22   IOSTANDARD LVCMOS25 } [get_ports { dphy_c_data_lp_n[0] }]; #IO_L10N_T1_17 Sch=fmc_la_n[25]
set_property -dict { PACKAGE_PIN D22   IOSTANDARD LVCMOS25 } [get_ports { dphy_c_data_lp_p[0] }]; #IO_L10P_T1_17 Sch=fmc_la_p[25]
set_property -dict { PACKAGE_PIN A22   IOSTANDARD LVCMOS25 } [get_ports { dphy_d_data_lp_n[0] }]; #IO_L23N_T3_17 Sch=fmc_la_n[26]
set_property -dict { PACKAGE_PIN B22   IOSTANDARD LVCMOS25 } [get_ports { dphy_d_data_lp_p[0] }]; #IO_L23P_T3_17 Sch=fmc_la_p[26]
set_property -dict { PACKAGE_PIN A21   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_d_data_hs_n[1] }]; #IO_L21N_T3_DQS_17 Sch=fmc_la_n[27]
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports { dphy_d_data_hs_p[1] }]; #IO_L21P_T3_DQS_17 Sch=fmc_la_p[27]
set_property -dict { PACKAGE_PIN H19   IOSTANDARD LVCMOS25 } [get_ports { dphy_d_data_lp_n[1] }]; #IO_L4N_T0_17 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS25 } [get_ports { dphy_d_data_lp_p[1] }]; #IO_L4P_T0_17 Sch=fmc_la_p[28]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS25 } [get_ports { cama_bta_tri_io[3] }]; #IO_L22N_T3_17 Sch=fmc_la_n[29]
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS25 } [get_ports { cama_bta_tri_io[2] }]; #IO_L22P_T3_17 Sch=fmc_la_p[29]
...
set_property -dict { PACKAGE_PIN AC24  IOSTANDARD LVCMOS33 } [get_ports { cam_iic_scl_io }]; #IO_L9P_T1_DQS_12 Sch=fmc_scl
set_property -dict { PACKAGE_PIN AD24  IOSTANDARD LVCMOS33 } [get_ports { cam_iic_sda_io }]; #IO_L9N_T1_DQS_12 Sch=fmc_sda
...
set_property -dict { PACKAGE_PIN AA21   IOSTANDARD LVCMOS33 } [get_ports { fmc_prsnt_tri_i }];

#set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets microblaze_3_i/mig_7series_0/u_microblaze_3_mig_7series_0_0_mig/u_ddr3_clk_ibuf/sys_clk_ibufg]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets microblaze_3_i/mig_7series_0/u_microblaze_3_mig_7series_0_0_mig/u_iodelay_ctrl/clk_ref_mmcm_400]